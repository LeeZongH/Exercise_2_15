%% 為了整潔性，將改寫後的程式放置於 "gen_data.m", 請查看或執行 "gen_data.m" 來產生 dataset
%% For cleanliness, the rewritten program is placed in "gen_data.m". Please view or run "gen_data.m" to generate the dataset.
