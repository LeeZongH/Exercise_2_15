...
# ────────────────────────  [個人註解]: (b) 只載入 Dataset 1 進行訓練, 其他當測試 ──────────────────── #
print("\nLoading Data 1 for Training")
trainid = 1
mat = sio.loadmat(f'data/DATA_Htrainin_ds{trainid}.mat') 
x_train = mat['HT'].astype('float32')

mat = sio.loadmat(f'data/DATA_Hvalin_ds{trainid}.mat')
x_val = mat['HT'].astype('float32')
...
# ────────────────────────  [個人註解]: (b) 測試 Dataset 1 到 5  ──────────────────── #
print("\n\n" + "="*50)
print("training finished :)")
print("="*50)

# [個人註解]: 訓練完 Dataset 1 後，依序載入dataset 1~5 測試資料進行評估
for i in range(1, 6):
